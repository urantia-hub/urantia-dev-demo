...
export async function searchParagraphs(q: string, type: "and" | "or" | "phrase" = "and", limit = 5) {
...
export async function semanticSearch(q: string, limit = 5) {
...
export async function getParagraphContext(ref: string, window = 2) {
...
export async function getEntities(params: { page?: number; limit?: number; type?: string; q?: string } = {}) {
...
export async function getEntityParagraphs(id: string, page = 1, limit = 5) {
...
export async function getAudio(paragraphId: string) {
